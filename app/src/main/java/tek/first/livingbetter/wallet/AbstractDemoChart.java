 ...
 */
public abstract class AbstractDemoChart implements tek.first.livingbetter.wallet.IChart {
  private Context context1;

  public AbstractDemoChart(Context context1) {
  ...
  protected CategorySeries buildCategoryDataset(String title, double[] values, double total) {
    DatabaseHelper helper = new DatabaseHelper(context1);
